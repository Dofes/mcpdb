...
#define SKY_STATIC_HOOK_IMPL(...) VA_EXPAND(SKY_MANUAL_REG_HOOK_IMPL((*), static, originFunc, __VA_ARGS__))

#define SKY_AUTO_STATIC_HOOK_IMPL(...) VA_EXPAND(SKY_AUTO_REG_HOOK_IMPL((*), static, originFunc, __VA_ARGS__))

#define SKY_INSTANCE_HOOK_IMPL(DEF_TYPE, ...)                                                                          \
    VA_EXPAND(SKY_MANUAL_REG_HOOK_IMPL((DEF_TYPE::*), , (this->*originFunc), DEF_TYPE, __VA_ARGS__))

#define SKY_AUTO_INSTANCE_HOOK_IMPL(DEF_TYPE, ...)                                                                     \
    VA_EXPAND(SKY_AUTO_REG_HOOK_IMPL((DEF_TYPE::*), , (this->*originFunc), DEF_TYPE, __VA_ARGS__))
...
#define SKY_TYPED_STATIC_HOOK(DefType, type, priority, identifier, Ret, ...)                                           \
    VA_EXPAND(SKY_STATIC_HOOK_IMPL(DefType, : public type, priority, identifier, Ret, __VA_ARGS__))
...
#define SKY_STATIC_HOOK(DefType, priority, identifier, Ret, ...)                                                       \
    VA_EXPAND(SKY_STATIC_HOOK_IMPL(DefType, , priority, identifier, Ret, __VA_ARGS__))
...
#define SKY_AUTO_TYPED_STATIC_HOOK(DefType, type, priority, identifier, Ret, ...)                                      \
    VA_EXPAND(SKY_AUTO_STATIC_HOOK_IMPL(DefType, : public type, priority, identifier, Ret, __VA_ARGS__))
...
#define SKY_AUTO_STATIC_HOOK(DefType, priority, identifier, Ret, ...)                                                  \
    VA_EXPAND(SKY_AUTO_STATIC_HOOK_IMPL(DefType, , priority, identifier, Ret, __VA_ARGS__))
...
#define SKY_TYPED_HOOK(DEF_TYPE, PRIORITY, TYPE, IDENTIFIER, RET_TYPE, ...)                                            \
    VA_EXPAND(SKY_INSTANCE_HOOK_IMPL(DEF_TYPE, : public TYPE, PRIORITY, IDENTIFIER, RET_TYPE, __VA_ARGS__))
...
#define SKY_INSTANCE_HOOK(DEF_TYPE, PRIORITY, IDENTIFIER, RET_TYPE, ...)                                               \
    VA_EXPAND(SKY_INSTANCE_HOOK_IMPL(DEF_TYPE, , PRIORITY, IDENTIFIER, RET_TYPE, __VA_ARGS__))
 ...
 */
#define SKY_AUTO_TYPED_INSTANCE_HOOK(DEF_TYPE, PRIORITY, TYPE, IDENTIFIER, RET_TYPE, ...)                              \
    VA_EXPAND(SKY_AUTO_INSTANCE_HOOK_IMPL(DEF_TYPE, : public TYPE, PRIORITY, IDENTIFIER, RET_TYPE, __VA_ARGS__))
...
#define SKY_AUTO_INSTANCE_HOOK(DEF_TYPE, PRIORITY, IDENTIFIER, RET_TYPE, ...)                                          \
    VA_EXPAND(SKY_AUTO_INSTANCE_HOOK_IMPL(DEF_TYPE, , PRIORITY, IDENTIFIER, RET_TYPE, __VA_ARGS__))